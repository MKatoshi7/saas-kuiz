                        ...
                        <div className="hidden md:block w-full md:w-3/5 bg-gray-100 p-6 animate-fade-in">
                            <div className="grid grid-cols-2 grid-rows-3 gap-4 h-full overflow-hidden">
                                ...
                                >
                                    ...
                                    <p className="text-center text-sm">Usuários ativos criando quizzes incríveis todos os dias.</p>
                                </div>
                                ...
                                >
                                    <h2 className="text-5xl font-bold mb-2">95%</h2>
                                    <p className="text-center text-sm">Taxa de satisfação dos nossos usuários com a plataforma.</p>
                                </div>
                        ...
                        >
                            ...
                            <div className="mb-8">
                                <h1 className={`text-2xl font-bold mb-1 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>
                                    {mode === 'signin' ? 'Entrar no' : 'Criar conta no'} <span className="text-blue-500">QuizK</span>
                                </h1>
                                <p className={`text-sm ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>
                                    {mode === 'signin'
